...
In order to validate this approach, I am currently in the process of collating energy consumption estimates using _carbon_, with the aim of comparing/benchmarking these against energy usage statistics provided by the data center hosting the CX3 and HX1 clusters.
